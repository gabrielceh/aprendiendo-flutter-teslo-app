...
class Price extends FormzInput<double, PriceError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == PriceError.value ) return 'El valor debe ser un número mayor o iguala cero';
    if ( displayError == PriceError.format ) return 'El valor debe ser un número';
